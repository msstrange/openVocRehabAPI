    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employment', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='testsite.Employment')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('basic_academic_training', models.OneToOneField(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='basic_academic_training', to='testsite.Service')),
                ('customized_training', models.OneToOneField(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='customized_training', to='testsite.Service')),
                ('disability_related_skills', models.OneToOneField(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='disability_related_skills', to='testsite.Service')),
                ('four_year_college', models.OneToOneField(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='four_year_college', to='testsite.Service')),
                ('graduate_college_university', models.OneToOneField(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='graduate_college_university', to='testsite.Service')),
                ('job_readiness_training', models.OneToOneField(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='job_readiness_training', to='testsite.Service')),
                ('junior_community_college', models.OneToOneField(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='junior_community_college', to='testsite.Service')),
                ('miscellaneous_training', models.OneToOneField(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='miscellaneous_training', to='testsite.Service')),
                ('occupational_vocational_training', models.OneToOneField(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='occupational_vocational_training', to='testsite.Service')),
                ('on_the_job_training', models.OneToOneField(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='on_the_job_training', to='testsite.Service')),
                ('randolph_sheppard_entrependeurial', models.OneToOneField(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='randolph_sheppard_entrependeurial', to='testsite.Service')),
                ('registered_apprenticeship_training', models.OneToOneField(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='registered_apprenticeship_training', to='testsite.Service')),
            ],
        ),
        migrations.CreateModel(
            name='VrUser',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('VR_SE_service', models.OneToOneField(null=True, on_delete='PROTECT', to='testsite.VrSeService')),
                ('application', models.OneToOneField(null=True, on_delete='PROTECT', to='testsite.Application')),
                ('career_services', models.OneToOneField(null=True, on_delete='PROTECT', to='testsite.CareerServices')),
                ('disability', models.OneToOneField(null=True, on_delete='PROTECT', to='testsite.Disability')),
                ('eligibility', models.OneToOneField(null=True, on_delete='PROTECT', to='testsite.Eligibility')),
                ('employment', models.OneToOneField(null=True, on_delete='PROTECT', to='testsite.Employment')),
                ('exit', models.OneToOneField(null=True, on_delete='PROTECT', to='testsite.Exit')),
                ('ipe', models.OneToOneField(null=True, on_delete='PROTECT', to='testsite.IndividualizedPlanForEmployment')),
                ('measurable_skill_gains', models.OneToOneField(null=True, on_delete='PROTECT', to='testsite.MeasurableSkillGains')),
                ('order_of_selection', models.OneToOneField(null=True, on_delete='PROTECT', to='testsite.OrderOfSelection')),
                ('other_service', models.OneToOneField(null=True, on_delete='PROTECT', to='testsite.OtherService')),
                ('post_exit', models.OneToOneField(null=True, on_delete='PROTECT', to='testsite.PostExit')),
                ('pre_employment_transition_services', models.OneToOneField(null=True, on_delete='PROTECT', to='testsite.PreemploymentTransitionServices')),
                ('trial_work_experience', models.OneToOneField(null=True, on_delete='PROTECT', to='testsite.TrialWorkExperience')),
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='counseling_on_enrollment', to='testsite.Service'),
        ),
        migrations.AddField(
            model_name='preemploymenttransitionservices',
            name='instruction_in_self_advocacy',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='instruction_in_self_advocacy', to='testsite.Service'),
        ),
        migrations.AddField(
            model_name='preemploymenttransitionservices',
            name='job_exploration_counseling',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='job_exploration_counseling', to='testsite.Service'),
        ),
        migrations.AddField(
            model_name='preemploymenttransitionservices',
            name='work_based_learning',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='work_based_learning', to='testsite.Service'),
        ),
        migrations.AddField(
            model_name='preemploymenttransitionservices',
            name='workplace_readiness_training',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='workplace_readiness_training', to='testsite.Service'),
        ),
        migrations.AddField(
            model_name='postexit',
            name='first_quarter',
            field=models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name='first_quarter', to='testsite.QuarterlyReport'),
        ),
        migrations.AddField(
            model_name='postexit',
            name='fourth_quarter',
            field=models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name='fourth_quarter', to='testsite.QuarterlyReport'),
        ),
        migrations.AddField(
            model_name='postexit',
            name='second_quarter',
            field=models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name='second_quarter', to='testsite.QuarterlyReport'),
        ),
        migrations.AddField(
            model_name='postexit',
            name='third_quarter',
            field=models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name='third_quarter', to='testsite.QuarterlyReport'),
        ),
        migrations.AddField(
            model_name='otherservice',
            name='interpreter_services',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='interpreter_services', to='testsite.Service'),
        ),
        migrations.AddField(
            model_name='otherservice',
            name='maintenance',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='maintenance', to='testsite.Service'),
        ),
        migrations.AddField(
            model_name='otherservice',
            name='other_services',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='other_services', to='testsite.Service'),
        ),
        migrations.AddField(
            model_name='otherservice',
            name='personal_assistance_services',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='personal_assistance_services', to='testsite.Service'),
        ),
        migrations.AddField(
            model_name='otherservice',
            name='reader_services',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='reader_services', to='testsite.Service'),
        ),
        migrations.AddField(
            model_name='otherservice',
            name='rehabilitation_technology',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='rehabilitation_technology', to='testsite.Service'),
        ),
        migrations.AddField(
            model_name='otherservice',
            name='technical_assistance_services',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='technical_assistance_services', to='testsite.Service'),
        ),
        migrations.AddField(
            model_name='otherservice',
            name='transportation',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='transportation', to='testsite.Service'),
        ),
        migrations.AddField(
            model_name='individualizedplanforemployment',
            name='employment',
            field=models.OneToOneField(on_delete='PROTECT', to='testsite.IpeEmployment'),
        ),
        migrations.AddField(
            model_name='individualizedplanforemployment',
            name='wioa_program_involvement',
            field=models.OneToOneField(on_delete='PROTECT', to='testsite.WIOAProgramInvolvement'),
        ),
        migrations.AddField(
            model_name='exit',
            name='medical_insurance',
            field=models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='testsite.MedicalInsuranceCoverage'),
        ),
        migrations.AddField(
            model_name='exit',
            name='support',
            field=models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='testsite.Support'),
        ),
        migrations.AddField(
            model_name='careerservices',
            name='assessment',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='assessment', to='testsite.Service'),
        ),
        migrations.AddField(
            model_name='careerservices',
            name='benefits_counseling',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='benefits_counseling', to='testsite.Service'),
        ),
        migrations.AddField(
            model_name='careerservices',
            name='customized_employment_services',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='customized_employment_services', to='testsite.Service'),
        ),
        migrations.AddField(
            model_name='careerservices',
            name='diagnosis_treatment_impairments',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='diagnosis_treatment_impairments', to='testsite.Service'),
        ),
        migrations.AddField(
            model_name='careerservices',
            name='extended_services',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='extended_services', to='testsite.Service'),
        ),
        migrations.AddField(
            model_name='careerservices',
            name='information_referral_services',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='information_referral_services', to='testsite.Service'),
        ),
        migrations.AddField(
            model_name='careerservices',
            name='job_placement_assistance',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='job_placement_assistance', to='testsite.Service'),
        ),
        migrations.AddField(
            model_name='careerservices',
            name='job_search_assistance',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='job_search_assistance', to='testsite.Service'),
        ),
        migrations.AddField(
            model_name='careerservices',
            name='short_term_job_support',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='short_term_job_support', to='testsite.Service'),
        ),
        migrations.AddField(
            model_name='careerservices',
            name='supported_employment_services',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='supported_employment_services', to='testsite.Service'),
        ),
        migrations.AddField(
            model_name='careerservices',
            name='vr_counseling_guidance',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='vr_counseling_guidance', to='testsite.Service'),
        ),
        migrations.AddField(
            model_name='application',
            name='individual_characteristics',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.PROTECT, to='testsite.IndividualCharacteristics'),
        ),
        migrations.AddField(
            model_name='application',
            name='location_information',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.PROTECT, to='testsite.LocationInformation'),
        ),
        migrations.AddField(
            model_name='application',
            name='medical_insurance_coverage',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.PROTECT, to='testsite.MedicalInsuranceCoverage'),
        ),
        migrations.AddField(
            model_name='application',
            name='support',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.PROTECT, to='testsite.Support'),
        ),
    ]
